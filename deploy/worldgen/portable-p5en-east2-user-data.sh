...
export MODEL_BUCKET=intelliverse-hyworld-private-us-east-2
export MODEL_BUCKET_REGION=us-east-2
export INSTANCE_TYPE=p5en.48xlarge
export INSTANCE_HOURLY_USD=63.296
export MAX_JOB_SECONDS=2200
export IDLE_SECONDS=0
# 51m40s bounds compute to $54.50; cache transfer and gp3 remain below $60.
export HARD_DEADLINE_SECONDS=3100
export GPU_COUNT=8
