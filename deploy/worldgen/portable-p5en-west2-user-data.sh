...
export MODEL_BUCKET_REGION=us-west-2
export INSTANCE_TYPE=p5en.48xlarge
export INSTANCE_HOURLY_USD=63.296
export MAX_JOB_SECONDS=2400
export IDLE_SECONDS=0
# 55 minutes bounds compute to $58.02; gp3 and NAT remain below $60.
export HARD_DEADLINE_SECONDS=3300
export GPU_COUNT=8
