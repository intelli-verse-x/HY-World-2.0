...
export INSTANCE_HOURLY_USD=68.80
export MAX_JOB_SECONDS=1800
export IDLE_SECONDS=0
# 43m20s caps compute at $49.69 and leaves first-attempt ancillary headroom.
export HARD_DEADLINE_SECONDS=2600
export GPU_COUNT=8
