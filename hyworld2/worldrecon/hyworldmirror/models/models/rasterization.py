...
try:
    ...
    # gsplat is only needed for actual rasterization (training / novel-view
    # rendering). Pure inference (is_inference=True) assembles splats without
    # rasterizing, so allow import to succeed without gsplat installed.
    rasterization = None
